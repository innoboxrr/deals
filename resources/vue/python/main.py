...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generar y gestionar archivos de locales para traducciones de Deals Manager.")
    ...
    parser.add_argument("-f", "--file", default=SRC_DIR, help="Archivo o directorio a buscar para cadenas __deals")
