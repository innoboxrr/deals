...
<script>
    ...
    import { createModel } from '@dealsModels/deal-ad-campaign'
	...
	export default {
        ...
        props: {
        	formId: {
        		type: String,
        		default: 'createDealAdCampaignForm',
        	},
            dealAdPlatformId: {
                type: [Number, String],
                required: true
        ...
        data() {
            return {
                ...
                total_conversions: '',
                conversion_rate: '',
                deal_ad_platform_id: this.dealAdPlatformId,
                disabled: false,
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    ...
                    createModel({
                        ...
                        deal_ad_platform_id: this.deal_ad_platform_id,
                    }).then(res => {
