<template>
	...
	<form :id="formId" @submit.prevent="onSubmit">
        ...
        <text-input-component
            ...
            label="Impresiones"
            validators="integer"
            v-model="deal.payload.impressions" />
...
<script>
    ...
    import { showModel, updateModel } from '@dealsModels/deal-ad-campaign'
	...
	export default {
        ...
        props: {
            formId: {
                type: String,
                default: 'editDealAdCampaignForm'
            },
            dealAdCampaignId: {
                type: [Number, String],
                required: true
            ...
            onSubmit() {
                if (this.JSValidator.status) {
                    ...
                    updateModel(this.deal.id, {
                        ...
                        impressions: this.deal.payload.impressions,
