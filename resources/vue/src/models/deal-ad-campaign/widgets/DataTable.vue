<template>
	...
	<data-table
		title="DealAdCampaign" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdCampaignExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad-campaign/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad-campaign' 
