<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealProductExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-product/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-product' 
