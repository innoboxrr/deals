		...
		<div class="flex justify-center items-center mt-8">
			...
			<div class="max-w-2xl w-full">
				...
				<div class="card bg-white dark:bg-slate-600 border rounded-lg px-8 pt-6 pb-8 mb-4 dark:border-slate-800">
					...
					<h2 class="text-4xl font-bold dark:text-white mb-6">Crear DealAdPlatforms</h2>
...
<script>
	...
	import { getPolicy } from '@dealsModels/deal-ad-platform'
	import CreateForm from '@dealsModels/deal-ad-platform/forms/CreateForm.vue'
