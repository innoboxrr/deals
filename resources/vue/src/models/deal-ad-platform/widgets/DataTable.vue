<template>
	...
	<data-table
		title="DealAdPlatform" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdPlatformExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad-platform/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad-platform' 
