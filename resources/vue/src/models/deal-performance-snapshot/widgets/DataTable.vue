<template>
	...
	<data-table
		title="DealPerformanceSnapshot" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealPerformanceSnapshotExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-performance-snapshot/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-performance-snapshot' 
	...
	export default {
		...
		computed: {
			...
			dealPerformanceSnapshotExternalFilters() {
