	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealPerformanceSnapshot,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealPerformanceSnapshot() {

	    		deleteModel(this.dealPerformanceSnapshot).then( res => {

	    			this.$router.push({ name: 'AdminDealPerformanceSnapshots' });
