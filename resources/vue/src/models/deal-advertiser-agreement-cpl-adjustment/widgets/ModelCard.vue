	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementCplAdjustment,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementCplAdjustment() {

	    		deleteModel(this.dealAdvertiserAgreementCplAdjustment).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementCplAdjustments' });
