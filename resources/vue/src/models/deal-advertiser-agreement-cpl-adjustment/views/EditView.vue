	...
	<div class="flex justify-center items-center">
		...
		<div class="max-w-2xl w-full">
			...
			<div class="card bg-white dark:bg-slate-600 border rounded-lg px-8 pt-6 pb-8 mb-4 dark:border-slate-800">
				...
				<edit-form 
					:key="$route.params.id"
					:deal-advertiser-agreement-cpl-adjustment-id="$route.params.id"
					@submit="formSubmit"/>
...
<script>
	...
	import EditForm from '@dealsModels/deal-advertiser-agreement-cpl-adjustment/forms/EditForm.vue'
