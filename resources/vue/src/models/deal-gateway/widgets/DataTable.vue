<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealGatewayExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-gateway/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-gateway' 
