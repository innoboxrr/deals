<template>
	...
	<data-table
		title="DealAdvertiserAgreementConstraint" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementConstraintExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-constraint/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-constraint' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementConstraintExternalFilters() {
