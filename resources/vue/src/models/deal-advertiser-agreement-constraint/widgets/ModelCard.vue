	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementConstraint,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementConstraint() {

	    		deleteModel(this.dealAdvertiserAgreementConstraint).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementConstraints' });
