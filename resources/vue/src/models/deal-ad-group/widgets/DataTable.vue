<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealAdGroupExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad-group/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad-group' 
