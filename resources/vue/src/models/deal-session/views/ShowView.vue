...
<script>
	...
	import { showModel } from '@models/deal-session'
	import ModelCard from '@models/deal-session/widgets/ModelCard.vue'
	import ModelProfile from '@models/deal-session/widgets/ModelProfile.vue'
