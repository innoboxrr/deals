	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementPostback,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementPostback() {

	    		deleteModel(this.dealAdvertiserAgreementPostback).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementPostbacks' });
