<template>
	...
	<data-table
		title="DealAdvertiserAgreementPostback" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementPostbackExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-postback/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-postback' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementPostbackExternalFilters() {
