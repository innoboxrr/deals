...
<script>
    ...
    import { showModel, updateModel} from '@dealsModels/deal-advertiser-agreement-postback'
...
//register_more_components//
        ...
        props: {
            formId: {
                type: String,
                default: 'editDealAdvertiserAgreementPostbackForm'
            },
        ...
        methods: {
            ...
            onSubmit() {
                if(this.JSValidator.status) {
                    this.disabled = true;
                    updateModel(this.dealAdvertiserAgreementPostback.id, {
//submit_data//
                    }).then( res => {
