...
<script>
	...
	import ModelCard from '@models/deal-advertiser-agreement/widgets/ModelCard.vue'
	import ModelProfile from '@models/deal-advertiser-agreement/widgets/ModelProfile.vue'
