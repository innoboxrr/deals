<template>
	...
	<data-table
		title="DealAdvertiserAgreement" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementExternalFilters() {
