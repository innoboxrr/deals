	...
	<div
		...
		<dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
			...
			<div class="sm:col-span-1">
				...
				<dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ dealAdvertiserAgreement.id }}</dd>
			</div>
		
			<div class="sm:col-span-1">
				<dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Other</dt>
				<dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ dealAdvertiserAgreement.other }}</dd>
			</div>
...
<script>
	...
	import { showModel } from '@models/deal-advertiser-agreement'
