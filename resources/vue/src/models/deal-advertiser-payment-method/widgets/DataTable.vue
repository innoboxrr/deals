<template>
	...
	<data-table
		title="DealAdvertiserPaymentMethod" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserPaymentMethodExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-payment-method/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-payment-method' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserPaymentMethodExternalFilters() {
