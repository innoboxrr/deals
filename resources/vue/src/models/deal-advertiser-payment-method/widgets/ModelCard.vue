	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserPaymentMethod,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserPaymentMethod() {

	    		deleteModel(this.dealAdvertiserPaymentMethod).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserPaymentMethods' });
