<template>
	...
	<data-table
		title="DealAdvertiserAgreementIntegration" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementIntegrationExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-integration/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-integration' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementIntegrationExternalFilters() {
