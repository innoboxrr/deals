...
<script>
	...
	import FilterForm from '@models/deal-advertiser-agreement-integration/forms/FilterForm.vue'
	import * as model from '@models/deal-advertiser-agreement-integration' 
