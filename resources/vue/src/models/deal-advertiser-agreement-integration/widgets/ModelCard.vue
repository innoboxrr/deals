	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementIntegration,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementIntegration() {

	    		deleteModel(this.dealAdvertiserAgreementIntegration).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementIntegrations' });
