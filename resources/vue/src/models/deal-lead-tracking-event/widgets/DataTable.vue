<template>
	...
	<data-table
		title="DealLeadTrackingEvent" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealLeadTrackingEventExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-lead-tracking-event/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-lead-tracking-event' 
	...
	export default {
		...
		computed: {
			...
			dealLeadTrackingEventExternalFilters() {
