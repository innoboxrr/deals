	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealLeadTrackingEvent,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealLeadTrackingEvent() {

	    		deleteModel(this.dealLeadTrackingEvent).then( res => {

	    			this.$router.push({ name: 'AdminDealLeadTrackingEvents' });
