<template>
	...
	<data-table
		title="DealAdvertiserAgreementDaily" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementDailyExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-daily/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-daily' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementDailyExternalFilters() {
