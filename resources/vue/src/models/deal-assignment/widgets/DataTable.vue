<template>
	...
	<data-table
		title="DealAssignment" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAssignmentExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-assignment/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-assignment' 
