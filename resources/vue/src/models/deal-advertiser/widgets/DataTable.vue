<template>
	...
	<data-table
		title="DealAdvertiser" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser' 
