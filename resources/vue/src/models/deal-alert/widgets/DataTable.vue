<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealAlertExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-alert/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-alert' 
