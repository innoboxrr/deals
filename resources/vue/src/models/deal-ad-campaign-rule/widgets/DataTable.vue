<template>
	...
	<data-table
		title="DealAdCampaignRule" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdCampaignRuleExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad-campaign-rule/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad-campaign-rule' 
	...
	export default {
		...
		computed: {
			...
			dealAdCampaignRuleExternalFilters() {
