	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementInvoice,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementInvoice() {

	    		deleteModel(this.dealAdvertiserAgreementInvoice).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementInvoices' });
