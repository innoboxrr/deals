<template>
	...
	<data-table
		title="DealAdvertiserAgreementInvoice" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementInvoiceExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-invoice/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-invoice' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementInvoiceExternalFilters() {
