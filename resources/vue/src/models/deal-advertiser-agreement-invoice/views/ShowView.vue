...
<script>
	...
	import ModelCard from '@models/deal-advertiser-agreement-invoice/widgets/ModelCard.vue'
	import ModelProfile from '@models/deal-advertiser-agreement-invoice/widgets/ModelProfile.vue'
