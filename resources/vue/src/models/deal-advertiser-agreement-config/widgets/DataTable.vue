<template>
	...
	<data-table
		title="DealAdvertiserAgreementConfig" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdvertiserAgreementConfigExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-advertiser-agreement-config/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-advertiser-agreement-config' 
	...
	export default {
		...
		computed: {
			...
			dealAdvertiserAgreementConfigExternalFilters() {
