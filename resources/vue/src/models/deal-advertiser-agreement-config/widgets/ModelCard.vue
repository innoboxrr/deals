	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdvertiserAgreementConfig,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdvertiserAgreementConfig() {

	    		deleteModel(this.dealAdvertiserAgreementConfig).then( res => {

	    			this.$router.push({ name: 'AdminDealAdvertiserAgreementConfigs' });
