<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealPixelFireExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-pixel-fire/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-pixel-fire' 
