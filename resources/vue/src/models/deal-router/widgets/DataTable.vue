<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealRouterExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-router/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-router' 
