...
export const API_ROUTE_PREFIX = 'api.innoboxrr.deals.deal_session_event.'; // Reemplaza con la ruta adecuada
	...
	return [
		{
			id: 'create',
			name: 'Create',
			callback: 'createDealSessionEvent',
			icon: 'fa-plus',
			route: true,
			policy: false,
			params: {
