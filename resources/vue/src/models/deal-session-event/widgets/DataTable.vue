<template>
	...
	<data-table
		title="DealSessionEvent" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealSessionEventExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-session-event/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-session-event' 
	...
	export default {
		...
		computed: {
			...
			dealSessionEventExternalFilters() {
