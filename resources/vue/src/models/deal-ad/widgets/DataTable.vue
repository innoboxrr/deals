<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealAdExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad' 
