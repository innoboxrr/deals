<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="dealLeadExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-lead/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-lead' 
