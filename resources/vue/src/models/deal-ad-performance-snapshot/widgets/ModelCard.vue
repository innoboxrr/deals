	    ...
	    <div class="flex justify-end">
			...
			<dropdown-button-component 
				:items="[
					...
					{
						type: 'event',
						action: deleteDealAdPerformanceSnapshot,
						label: 'Eliminar',
					},
				]"/>
...
<script>
	...
	export default {
	    ...
	    methods: {
	    	...
	    	deleteDealAdPerformanceSnapshot() {

	    		deleteModel(this.dealAdPerformanceSnapshot).then( res => {

	    			this.$router.push({ name: 'AdminDealAdPerformanceSnapshots' });
