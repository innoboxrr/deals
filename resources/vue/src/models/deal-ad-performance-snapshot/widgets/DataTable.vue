<template>
	...
	<data-table
		title="DealAdPerformanceSnapshot" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealAdPerformanceSnapshotExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-ad-performance-snapshot/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-ad-performance-snapshot' 
	...
	export default {
		...
		computed: {
			...
			dealAdPerformanceSnapshotExternalFilters() {
