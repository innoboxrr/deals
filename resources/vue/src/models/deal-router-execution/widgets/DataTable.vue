<template>
	...
	<data-table
		title="DealRouterExecution" 
		:data-url="dataUrl"
		data-method="get"
		:policy-url="policyUrl"
		policy-method="get"
		:model="model"
		:external-filters="dealRouterExecutionExternalFilters"
...
<script>
	...
	import FilterForm from '@dealsModels/deal-router-execution/forms/FilterForm.vue'
	import * as model from '@dealsModels/deal-router-execution' 
	...
	export default {
		...
		computed: {
			...
			dealRouterExecutionExternalFilters() {
