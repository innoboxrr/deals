...
<script>
	...
	import ModelCard from '@models/deal-router-execution/widgets/ModelCard.vue'
	import ModelProfile from '@models/deal-router-execution/widgets/ModelProfile.vue'
