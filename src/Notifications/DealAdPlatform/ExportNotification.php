...
namespace Innoboxrr\Deals\Notifications\DealAdPlatform;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdPlatformsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdPlatformsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdPlatform export notification';
    }
