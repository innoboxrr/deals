...
namespace Innoboxrr\Deals\Notifications\DealAlert;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAlertsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAlertsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAlert export notification';
    }
