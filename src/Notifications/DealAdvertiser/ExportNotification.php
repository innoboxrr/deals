...
namespace Innoboxrr\Deals\Notifications\DealAdvertiser;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertisersExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertisersExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiser export notification';
    }
