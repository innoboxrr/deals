...
namespace Innoboxrr\Deals\Notifications\DealRouterExecution;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealRouterExecutionsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealRouterExecutionsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealRouterExecution export notification';
    }
