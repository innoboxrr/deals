...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserAgreementDaily;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserAgreementDailiesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserAgreementDailiesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserAgreementDaily export notification';
    }
