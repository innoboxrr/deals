...
namespace Innoboxrr\Deals\Notifications\DealAssignment;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAssignmentsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAssignmentsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAssignment export notification';
    }
