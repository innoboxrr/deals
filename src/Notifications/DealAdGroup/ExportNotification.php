...
namespace Innoboxrr\Deals\Notifications\DealAdGroup;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdGroupsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdGroupsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdGroup export notification';
    }
