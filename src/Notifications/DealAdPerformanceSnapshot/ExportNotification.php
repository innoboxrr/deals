...
namespace Innoboxrr\Deals\Notifications\DealAdPerformanceSnapshot;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdPerformanceSnapshotsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdPerformanceSnapshotsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdPerformanceSnapshot export notification';
    }
