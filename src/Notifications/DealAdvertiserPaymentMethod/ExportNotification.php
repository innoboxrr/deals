...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserPaymentMethod;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserPaymentMethodsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserPaymentMethodsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserPaymentMethod export notification';
    }
