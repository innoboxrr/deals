...
namespace Innoboxrr\Deals\Notifications\DealProduct;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealProductsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealProductsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealProduct export notification';
    }
