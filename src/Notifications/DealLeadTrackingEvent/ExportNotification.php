...
namespace Innoboxrr\Deals\Notifications\DealLeadTrackingEvent;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealLeadTrackingEventsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealLeadTrackingEventsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealLeadTrackingEvent export notification';
    }
