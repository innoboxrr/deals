...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserAgreementConfig;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserAgreementConfigsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserAgreementConfigsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserAgreementConfig export notification';
    }
