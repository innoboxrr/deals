...
namespace Innoboxrr\Deals\Notifications\DealSessionEvent;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealSessionEventsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealSessionEventsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealSessionEvent export notification';
    }
