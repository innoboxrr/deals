...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserAgreementIntegration;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserAgreementIntegrationsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserAgreementIntegrationsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserAgreementIntegration export notification';
    }
