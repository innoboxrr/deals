...
namespace Innoboxrr\Deals\Notifications\DealAdCampaign;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdCampaignsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdCampaignsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdCampaign export notification';
    }
