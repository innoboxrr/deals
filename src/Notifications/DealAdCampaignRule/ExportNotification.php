...
namespace Innoboxrr\Deals\Notifications\DealAdCampaignRule;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdCampaignRulesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdCampaignRulesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdCampaignRule export notification';
    }
