...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserAgreementInvoice;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserAgreementInvoicesExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserAgreementInvoicesExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserAgreementInvoice export notification';
    }
