...
namespace Innoboxrr\Deals\Notifications\DealPixelFire;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealPixelFiresExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealPixelFiresExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealPixelFire export notification';
    }
