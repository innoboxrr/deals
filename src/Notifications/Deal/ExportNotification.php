...
namespace Innoboxrr\Deals\Notifications\Deal;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        return env('APP_NAME') . ' | Deal export notification';
    }
