...
namespace Innoboxrr\Deals\Notifications\DealAd;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        return env('APP_NAME') . ' | DealAd export notification';
    }
