...
namespace Innoboxrr\Deals\Notifications\DealGateway;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealGatewaysExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealGatewaysExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealGateway export notification';
    }
