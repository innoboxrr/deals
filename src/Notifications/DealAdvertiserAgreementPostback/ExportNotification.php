...
namespace Innoboxrr\Deals\Notifications\DealAdvertiserAgreementPostback;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealAdvertiserAgreementPostbacksExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealAdvertiserAgreementPostbacksExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealAdvertiserAgreementPostback export notification';
    }
