...
namespace Innoboxrr\Deals\Notifications\DealPerformanceSnapshot;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealPerformanceSnapshotsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealPerformanceSnapshotsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealPerformanceSnapshot export notification';
    }
