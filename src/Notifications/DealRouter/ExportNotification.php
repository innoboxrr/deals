...
namespace Innoboxrr\Deals\Notifications\DealRouter;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealRoutersExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealRoutersExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealRouter export notification';
    }
