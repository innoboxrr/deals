...
namespace Innoboxrr\Deals\Notifications\DealLead;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealLeadsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealLeadsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealLead export notification';
    }
