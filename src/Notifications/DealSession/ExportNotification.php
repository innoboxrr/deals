...
namespace Innoboxrr\Deals\Notifications\DealSession;

use Maatwebsite\Excel\Facades\Excel;
use Innoboxrr\Deals\Exports\DealSessionsExports;
...
class ExportNotification extends Notification
{
    ...
    {
        Excel::store(
            new DealSessionsExports($this->data), 
            $this->path, 
    ...
    {
        return env('APP_NAME') . ' | DealSession export notification';
    }
