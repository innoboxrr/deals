...
class DealAdvertiserAgreementIntegrationResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewDealAdvertiserAgreementIntegration',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editDealAdvertiserAgreementIntegration',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
