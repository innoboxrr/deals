...
class DealAdvertiserAgreementPostbackResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewDealAdvertiserAgreementPostback',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editDealAdvertiserAgreementPostback',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
