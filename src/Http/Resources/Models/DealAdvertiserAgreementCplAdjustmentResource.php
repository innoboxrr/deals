...
class DealAdvertiserAgreementCplAdjustmentResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewDealAdvertiserAgreementCplAdjustment',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editDealAdvertiserAgreementCplAdjustment',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
