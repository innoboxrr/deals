...
class DealAdvertiserAgreementInvoiceResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewDealAdvertiserAgreementInvoice',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editDealAdvertiserAgreementInvoice',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
