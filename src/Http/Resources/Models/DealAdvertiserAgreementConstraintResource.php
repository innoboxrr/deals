...
class DealAdvertiserAgreementConstraintResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewDealAdvertiserAgreementConstraint',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editDealAdvertiserAgreementConstraint',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
