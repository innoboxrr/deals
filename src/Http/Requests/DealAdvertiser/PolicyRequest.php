...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealAdvertiser,id',
    ...
    public function handle()
    {
         ...
         $dealAdvertiser = ($this->id) ? 
            DealAdvertiser::findOrFail($this->id) : 
            app(DealAdvertiser::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealAdvertiser),
        ]);
