...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealAdvertiserAgreement,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealAdvertiserAgreement::findOrFail($this->id) : app(DealAdvertiserAgreement::class);
