...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealAdvertiserAgreementIntegration,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealAdvertiserAgreementIntegration::findOrFail($this->id) : app(DealAdvertiserAgreementIntegration::class);
