...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealSessionEvent,id',
    ...
    public function handle()
    {
         ...
         $dealSessionEvent = ($this->id) ? 
            DealSessionEvent::findOrFail($this->id) : 
            app(DealSessionEvent::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealSessionEvent),
        ]);
