...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealAdCampaignRule,id',
    ...
    public function handle()
    {
         ...
         $dealAdCampaignRule = ($this->id) ? 
            DealAdCampaignRule::findOrFail($this->id) : 
            app(DealAdCampaignRule::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealAdCampaignRule),
        ]);
