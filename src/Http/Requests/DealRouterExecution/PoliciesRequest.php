...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealRouterExecution,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealRouterExecution::findOrFail($this->id) : app(DealRouterExecution::class);
