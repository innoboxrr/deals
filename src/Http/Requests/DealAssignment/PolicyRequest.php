...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealAssignment,id',
    ...
    public function handle()
    {
         ...
         $dealAssignment = ($this->id) ? 
            DealAssignment::findOrFail($this->id) : 
            app(DealAssignment::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealAssignment),
        ]);
