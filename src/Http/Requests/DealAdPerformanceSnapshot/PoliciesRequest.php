...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealAdPerformanceSnapshot,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealAdPerformanceSnapshot::findOrFail($this->id) : app(DealAdPerformanceSnapshot::class);
