...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealAdCampaign,id',
    ...
    public function handle()
    {
         ...
         $dealAdCampaign = ($this->id) ? 
            DealAdCampaign::findOrFail($this->id) : 
            app(DealAdCampaign::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealAdCampaign),
        ]);
