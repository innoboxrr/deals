...
use Innoboxrr\Deals\Http\Events\DealRouter\Events\DeleteEvent;
...
class DeleteRequest extends FormRequest
{
    ...
    public function authorize()
    {
        ...
        return $this->user()->can('delete', $dealRouter);
    ...
    public function handle()
    {
        ...
        $dealRouter->deleteModel();

        $response = new DealRouterResource($dealRouter);

        event(new DeleteEvent($dealRouter, $this->all(), $response));
