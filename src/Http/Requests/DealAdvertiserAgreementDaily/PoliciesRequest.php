...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealAdvertiserAgreementDaily,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealAdvertiserAgreementDaily::findOrFail($this->id) : app(DealAdvertiserAgreementDaily::class);
