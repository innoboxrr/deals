...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\Deals\Models\DealPixelFire,id',
    ...
    public function handle()
    {
         ...
         $dealPixelFire = ($this->id) ? 
            DealPixelFire::findOrFail($this->id) : 
            app(DealPixelFire::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $dealPixelFire),
        ]);
