...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\Deals\Models\DealAdvertiserAgreementInvoice,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? DealAdvertiserAgreementInvoice::findOrFail($this->id) : app(DealAdvertiserAgreementInvoice::class);
